...
MSFilter *Capturer::_configure(MSFilter *source) {
  ...
  /*if (ms_filter_has_method(source, MS_VIDEO_CAPTURE_SET_DEVICE_ORIENTATION))
          ms_filter_call_method(source, MS_VIDEO_CAPTURE_SET_DEVICE_ORIENTATION,
  0); if (ms_filter_has_method(source, MS_VIDEO_DISPLAY_SET_DEVICE_ORIENTATION))
  {
          ms_filter_call_method(source, MS_VIDEO_DISPLAY_SET_DEVICE_ORIENTATION,
  0);
  }*/
  ...
  } else if (!ms_filter_implements_interface(source,
...
void Capturer::snapshot() {
  ...
  ms_filter_add_notify_callback(this->_sink, Capturer::_onSnapshotTaken, this,
                                false);
  ...
  ms_filter_call_method(this->_sink, MS_JPEG_WRITER_TAKE_SNAPSHOT,
...
// static
void Capturer::_onSnapshotTaken(void *userdata, MSFilter *f, unsigned int id,
                                void *arg) {
