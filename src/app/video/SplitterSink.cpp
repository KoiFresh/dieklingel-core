...
void SplitterSink::_preprocess(MSFilter *filter)
{
	...
	SplitterSource::State *sourceState = (SplitterSource::State *)sinkState->splitterSource->data;
...
MSFilterDesc SplitterSink::description = {
	...
	.name = "SplitterSink",
	.text = "A filter that was created from a SplitterSource and acts like a Source to a graph",
